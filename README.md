...
**🎯 用户体验提升**：
- 🔧 **配置文件模板更新**: `config_demo.yaml` 添加启动模块配置说明
- 📱 **界面一致性**: 确保自选列表和持股列表在功能和交互上的一致性体验
- 🌐 **完整多语言支持**: 所有新功能均支持中英文双语界面

**📋 自选列表当前展示**：
```
代码 | 名称 | 现价 | 昨收价 | 开盘 | 最高 | 最低 | 今日涨幅 | 换手率 | 成交量
```
...
system:
    language: zh
    auto_start: true
    startup_module: watchlist  # 启动时进入自选模块
    debug_mode: false
```
