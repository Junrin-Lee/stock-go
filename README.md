...
2. 系统实时获取股价并显示详细表格，包含：序号、股票代码、股票名称、现价、成本价、持股数、今日涨幅、当日盈亏、总盈亏、盈亏率、市值
3. 智能颜色显示：红色盈利/上涨，绿色亏损/下跌，白色持平
4. 显示投资组合汇总数据：总当日盈亏、总盈亏、总盈亏率、总市值
5. 按 ESC 或 Q 返回主菜单
