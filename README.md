...
本版本重点增强了分时图表功能和用户体验：
- 📊 **分时图表优化**: 全新的图表渲染引擎，使用 Braille 字符实现平滑曲线
- 🕐 **智能日期选择**: 开盘前自动显示上一交易日数据，避免空白图表
- 📈 **自适应Y轴**: 根据价格波动率动态调整图表边距，优化视觉效果
- ⏰ **完整时间轴**: 固定9:30-15:00时间框架，正确处理午休时段
- 🎯 **交易时段提示**: 图表界面显示关键交易时间点标记
...
- **[当前版本 v4.9](doc/version/v4.9.md)** - 分时图表增强与智能日期选择 ⭐
