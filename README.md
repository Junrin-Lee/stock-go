...
- **自动市场识别**: 根据股票代码自动识别市场类型（A股/美股/港股）
- **市场标签显示**: 在自选列表中显示市场标签，与用户标签分离
- **数据自动迁移**: 自动处理旧版本数据中的市场标签清理和转移
- **多语言支持**: 市场标签支持中英文显示（A股/美股/港股 或 A-Share/US Stock/HK Stock）
- **向下兼容**: 完全兼容v5.4，零迁移风险
...
| 版本 | 发布时间 | 主要更新 | 文档 |
|------|----------|----------|------|
| **v5.5** | 2025年12月 | 🏷️ 自选股票市场标签体系、数据自动迁移 | [查看详情](doc/version/v5.5.md) |
| v5.4 | 2025年12月 | 🔧 港股换手率修复、东方财富API集成 | [查看详情](doc/version/v5.4.md) |
...
| v4.7 | 2025年10月 | 架构优化，国际化增强 | [查看详情](doc/version/v4.7.md) |
| v4.6 | 2025年10月 | 分时数据采集，异步优化 | [查看详情](doc/version/v4.6.md) |
| v4.5 | 2025年09月 | 高级排序系统 | [查看详情](doc/version/v4.5.md) |
