...
**Keyboard Controls**:
- `↑↓ Arrow Keys` or `W/S/J/K` - Navigate menu items
...
- **A-Shares:** Support multiple formats
  - `SH601138` or `601138` → Auto-convert to `601138.SS` (Shanghai Stock Exchange)
  - `SZ000001` or `000001` → Auto-convert to `000001.SZ` (Shenzhen Stock Exchange)
  - Direct standard format: `601138.SS`, `000001.SZ`
- **Hong Kong Stocks:** 
  - `HK0700` → Auto-convert to `0700.HK`
